...
class MsiImageWriter:
    def __init__(self, dframe, embedding, cmap=plt.cm.get_cmap("viridis"), colorscale_boundary=(0,100)):
        self.dframe = dframe
    ...
    def write_component_img(self, nth_component):
        intens = self.embedding[:, nth_component]
    ...
    def write_dimvis_rgb(self, red_ch, green_ch, blue_ch):
        ...
        rgb_img = np.zeros((self.height, self.width, 4))
        ...
        rgb_img[(self.grid_y, self.grid_x, 3)] = 255
